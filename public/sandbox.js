...
let posts = []; // posts an array of strings, initialise with empty value
...
uid = "123";
// Objects
let myObj; // Note array is a type of object
myObj = { message: "hello", likes: 50, published: true };
let myObjTwo; // Stricter object setting, array would not be allowed
